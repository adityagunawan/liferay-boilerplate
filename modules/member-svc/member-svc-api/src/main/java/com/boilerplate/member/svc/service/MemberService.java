...
public interface MemberService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.boilerplate.member.svc.service.impl.MemberServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the member remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MemberServiceUtil} if injection and service tracking are not available.
	 */
